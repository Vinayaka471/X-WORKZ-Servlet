...
<div class="form-container">
    <h2>Your Response</h2>
    Birth Id: ${birth.birthBirthId}<br>
    Hospital Name: ${birth.hospitalName}<br>
    Father Name: ${birth.fatherName}<br>
    Mother Name: ${birth.motherName}<br>
    Date and Time: ${birth.dateAndTime}<br>
    Doctor Name: ${birth.doctorName}<br>
    Nurse Name: ${birth.nurseName}<br>
    Hospital Type:  ${birth.hospitalType}<br>
</div>
